<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="签约医生" width="110" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="预设值" width="150" align="center">
        <template slot-scope="scope">
          {{ scope.row.pageviews }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="预警时间" min-width="180" align="center">
        <template slot-scope="scope">
          {{ scope.row.pageviews }}
        </template>
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      fetchData() {
        ...
        service.get("/manage/alarm/list",  {params: this.listQuery}).then(response => {
