<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="开具时间" width="200" align="center">
        <template slot-scope="scope">
          {{ scope.row.createTimeStr }}
        </template>
      </el-table-column>

      <el-table-column label="处方详情" align="center">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        service.get("/manage/medical/prescriptionList", { params: this.listQuery }).then(resp => {
          console.log(resp);
