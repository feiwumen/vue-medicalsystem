<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="回访时间" width="200" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="回访说明" align="center">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        service.get("/manage/medical/revisitList", { params: this.listQuery }).then(resp => {
          console.log(resp);
