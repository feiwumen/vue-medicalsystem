<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="咨询时间" width="200" align="center">
        <template slot-scope="scope">
          {{ scope.row.reserveTimeStr }}
        </template>
      </el-table-column>

      <el-table-column label="咨询名称" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.symptoms }}
        </template>
      </el-table-column>

      <el-table-column label="病情主诉" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="病历照片" width="200" align="center">
        <template slot-scope="scope">
          {{ scope.row.recordUrls }}
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        service.get("/manage/medical/consultList", { params: this.listQuery }).then(resp => {
          console.log(resp);
